...
public interface ParserCssListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ParserCss#border_value}.
	 * @param ctx the parse tree
	 */
	void enterBorder_value(ParserCss.Border_valueContext ctx);
	/**
	 * Exit a parse tree produced by {@link ParserCss#border_value}.
	 * @param ctx the parse tree
	 */
	void exitBorder_value(ParserCss.Border_valueContext ctx);
	/**
